...
def test_merge_observations_different_timeseries():
    ...
    assert omerged.shape == (20,1), 'merged observation should have one column with 20 values'
...
def test_merge_overlapping():
    ...
    assert omerged.shape == (15,3), 'merged observation should have one column with 20 values'
